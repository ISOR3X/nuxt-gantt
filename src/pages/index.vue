  ...
  events: [
    {
      ...
      label: "Deadline 1",
      type: "deadline",
      startDate: Temporal.Now.plainDateISO().add({ weeks: 8 }),
    },
    {
      id: "f92mro",
      label: "Today",
    ...
    {
      id: "g02cnt",
      label: "Visit from customer",
      startDate: Temporal.Now.plainDateISO().add({ weeks: 6 }),
      endDate: Temporal.Now.plainDateISO().add({ weeks: 7 }),
      color: "info",
    },
    {
      id: "20fm2d",
      label: "Holiday",
      startDate: Temporal.Now.plainDateISO().add({ weeks: 3 }),
      endDate: Temporal.Now.plainDateISO().add({ weeks: 5 }),
    },
  ],
  tasks: [],
});
